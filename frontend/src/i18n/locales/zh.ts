export default {
  ...
  admin: {
    ...
    settings: {
      ...
      payment: {
        ...
        balanceRechargeTiers: '余额充值挡位',
        balanceRechargeTiersHint: '配置固定充值挡位：支付金额按人民币收款，到账金额按 USD 余额入账。配置挡位后，用户端优先展示挡位按钮。',
        tierLabel: '标签',
        tierPayAmount: '支付金额(CNY)',
        tierCreditAmount: '到账余额(USD)',
        tierSortOrder: '排序',
        tierEnabled: '启用',
        addTier: '添加挡位',
        removeTier: '删除',
  ...
  payment: {
    ...
    errors: {
      ...
      paymentGatewayTimeout: '支付网关响应超时，请稍后重试。',
