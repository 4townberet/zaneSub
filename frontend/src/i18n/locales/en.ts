export default {
  ...
  admin: {
    ...
    settings: {
      ...
      payment: {
        ...
        balanceRechargeTiers: 'Balance Recharge Tiers',
        balanceRechargeTiersHint: 'Configure fixed recharge tiers: the payment amount is charged in CNY, and the credited amount is added as USD balance. When tiers are configured, users see tier buttons first.',
        tierLabel: 'Label',
        tierPayAmount: 'Pay Amount (CNY)',
        tierCreditAmount: 'Credit Amount (USD)',
        tierSortOrder: 'Sort',
        tierEnabled: 'Enabled',
        addTier: 'Add Tier',
        removeTier: 'Remove',
  ...
  payment: {
    ...
    errors: {
      ...
      paymentGatewayTimeout: 'The payment gateway timed out. Please try again shortly.',
